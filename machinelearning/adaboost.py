...
class AdaBoost:
    def __init__(self, epsilon=0.0):
        ...
        self.w = None #样本的权重，每加入一个基本分类器都要重新计算
        self.N = None
        self.g_list = [] # 弱分类器
